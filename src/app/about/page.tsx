...
export default function AboutPage() {
  const paragraphs = [
    ...
    "Currently, I am pursuing a fully funded fellowship in Business Management and Strategy during weekends. As with my past career choices, I am once again guided by my obsession with following my curiosity. As I took a data-driven approach to understanding human behaviours during my PhD, I found myself motivated to study human behaviours (reflected in economics and sociology). This engagement is an effort to fill that gap while meeting changemakers from around the world. It will fuel my interest in creating impactful, scalable ventures by becoming a part of the entrepreneurship and startup ecosystem.",
