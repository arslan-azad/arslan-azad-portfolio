...
export default function SelectedExperiences() {
  const experiences = [
    ...
    },
    {
      ...
      description: "Taught Design Thinking & Data Visualisation, Statistical Methods, Social Media Analytics, and Machine Learning. Designed industry-aligned curricula and advancing Generative AI in education for AI-driven learning solutions.",
